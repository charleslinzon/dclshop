                                ...
                                <tbody>
                                    { [1,2,3,4,5].map((d, i) => 
                                        <tr key={i}>
                                            ...
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>$345</td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>10%</td><td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>20</td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                                <div className='flex justify-start items-center gap-4'>
                                                    <Link to={`/seller/dashboard/edit-product/2`} className='p-[6px] bg-yellow-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'><FaEdit /></Link>
