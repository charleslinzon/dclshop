    ...
    const Row = ({ index, style }) => {
        return (
            <div style={style} className='flex text-sm text-white font-medium'>
                ...
                <div className='w-[25%] p-2 whitespace-nowrap'>$5453</div>
           ...
           <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7 mb-5' >
                ...
                <div className='flex justify-between items-center p-5 bg-[#fae8e8] rounded-md gap-3'>
                    <div className='flex flex-col justify-start items-start text-[#5c5a5e]'>
                        <h2 className='text-2xl font-bold'>$2343</h2>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-2 pb-4'>
                    ...
                    <div className='pt-5 mb-5'>
                        <form>
                            <div className='flex gap-3 flex-wrap'>
                                ...
                                <button className='bg-red-500 hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-1.5'>Subtmt</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div>
                        ...
                        <div className='w-full'>
                            <div className='w-full overflow-x-auto'>
                                <div className='flex bg-[#a7a3de] uppercase text-xs font-bold min-w-[34-px] rounded-md'>
                ...
                <div className='bg-[#6a5fdf] text-[#d0d2d6] rounded-md p-5'>
                    <div>
                        <h2 className='text-lg pb-4'>Success Widthdrawal</h2>
