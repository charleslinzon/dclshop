                                ...
                                { [1,2,3,4,5].map((d, i) => 
                                    <tr key={i}>
                                        ...
                                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                            ...
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Charles Dy</td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>DCL Shop</td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>Pending</span></td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>dycharles@gmail.com</td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Lakeside</td>
                                            <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Southern</td>
                                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
